            ...
            <form action="/user/registration" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="name"
                           value="<?php echo isset($_SESSION['data']['name']) ? $_SESSION['data']['name'] : ''; ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" name="password"
                           value="<?php echo isset($_SESSION['data']['password']) ? $_SESSION['data']['password'] : ''; ?>">
                    <span style="color:#ff0000;font-size: 14px;"><?= error('password'); ?></span>
                </div>
